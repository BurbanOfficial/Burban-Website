...
registerForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    // On attend que Firebase Auth ait bien créé l'utilisateur
    ...
    // Ensuite seulement, création du document Firestore
    ...
    showNotification("Account created", "Your account has been created, please verify your email.");
    registerForm.reset();
    auth.signOut();
